...
<body>
	...
	<div class="row">
		<form class="col s6" action="/barista/index?action=PesquisarComida"
			method="post">
								...
								<td>
									<div class="col s6">
										<a class="btn waves-effect waves-light brown"
											href="/barista/index?action=EditarComida&id=${ex.id}">Editar</a>
									</div>

									<form action="/barista/index?action=RemoverComida"
										method="post">
